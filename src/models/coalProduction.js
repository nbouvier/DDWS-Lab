...
async function setCoalPowerPlantProduction() {
    let coalPowerPlants = await db.query('SELECT cpp.id, cpp.buffer_percentage, b.id AS b_id, b.capacity AS b_capacity, b.resource AS b_resource FROM coal_power_plant cpp JOIN buffer b ON cpp.buffer_id = b.id;')
